...
const ChatWindow: React.FC<ChatWindowProps> = ({ onClose }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#1A1A1A] rounded-2xl overflow-hidden shadow-xl">
      {/* Header */}
      <div className="flex items-center justify-between px-4 h-[52px] bg-black">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button onClick={onClose} className="text-[#A9A7A7] hover:text-white transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
      </div>
